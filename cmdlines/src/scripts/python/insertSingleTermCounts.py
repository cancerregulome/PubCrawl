...
def usage():
    print "python insertSingleTermCounts.py [-a][-d][-s] -f singleTermCountFile";
    print "-a   term count file includes aliases";
    print "-d   this is a denovo search";
    print "-s   this is a small molecule/drug search";
...
if __name__ == "__main__":
    try:
        optlist, args=getopt.getopt(sys.argv[1:],'adsf:')
    except:
        usage_error();
        exit(1);
